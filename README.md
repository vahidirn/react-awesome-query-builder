# react-awesome-query-builder-irn
<a href='https://www.npmjs.com/package/react-awesome-query-builder-irn'><img src='https://img.shields.io/npm/v/react-awesome-query-builder-irn.svg' /> <img src='https://travis-ci.org/vahidirn/react-awesome-query-builder-irn.svg?branch=master' /></a>
...
For [antd v2](https://2x.ant.design/docs/react/introduce) (which has more compact style) see [branch antd-2](https://github.com/vahidirn/react-awesome-query-builder-irn/tree/antd-2) and versions `0.1.*`. 
...
### Demo
[Live Demo](https://vahidirn.github.io/react-awesome-query-builder-irn)

![Screenshot](https://vahidirn.github.io/react-awesome-query-builder-irn/screenshot.png)


### Install
Install: `npm i react-awesome-query-builder-irn`
...
import {Query, Builder, Utils as QbUtils} from 'react-awesome-query-builder-irn';
import config from './config'; //see below 'Config format'
import 'react-awesome-query-builder-irn/css/styles.scss';
import 'react-awesome-query-builder-irn/css/compact_styles.scss';
import 'react-awesome-query-builder-irn/css/denormalize.scss';
